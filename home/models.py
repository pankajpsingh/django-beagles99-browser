...
class People(index.Indexed, ClusterableModel):
    ...
    partner_id = models.PositiveIntegerField('Partner ID', null=True, blank=True)
    email_id = models.EmailField('Email ID', blank=True, null=True)
    phone = models.CharField('Phone', max_length=99, null=True, blank=True)
    image = models.ForeignKey('wagtailimages.Image', null=True, blank=True, on_delete=models.SET_NULL, related_name='+')

    panels = [
        FieldPanel('name'),
        FieldPanel('bio'),
        FieldPanel('partner_id'),
        FieldPanel('email_id'),
        FieldPanel('phone'),
...
class StandardPage(Page):
    """
    A generic content page. On our demo site we use it for an about page but
...
class State(models.Model):
    ...
    """
    state_name = models.CharField('State Name', max_length=100)
    gst_state_code = models.CharField('GST State Code', max_length=5, null=True, blank=True)
    state_code = models.CharField('State Code', max_length=5, null=True, blank=True)
    country_name = models.ForeignKey('Country', on_delete=models.CASCADE, related_name='states')
